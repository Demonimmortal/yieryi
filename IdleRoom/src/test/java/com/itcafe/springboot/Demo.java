...
import com.idleroom.web.util.cmq.CMQClientException;
...
import com.idleroom.web.util.cmq.QueueMeta;
...
public class Demo {
    ...
    try
    {
		...
		String msgId = queue.sendMessage("hello world,this is mq sdk for java");
		System.out.println("[hello world,this is mq sdk for java] sent");
		...
		String msgBody = "hello world,this is mq sdk for java 1";
		vtMsgBody.add(msgBody);
		msgBody = "hello world,this is mq sdk for java 2";
		vtMsgBody.add(msgBody);
		msgBody = "hello world,this is mq sdk for java 3";
		vtMsgBody.add(msgBody);
